...
{ type: 'SET_SIGNATORY', signatory: { first_name, last_name, email } }  // contract widget only
```
...
{ type: 'CONTRACT_SIGNED', data: { signedContractUrl: '<url>' } }  // organisation contract signed
```
